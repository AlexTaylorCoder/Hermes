...
class PostMesssage extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit() {
    ...
    fetch("/messages",{...header,
      body: JSON.stringify({post:markup,user_id:id,channel_id:channel_id,sub_channel_id:sub_channel_id})})
  }
      ...
      <div className="RichEditor-root">
        ...
        <div className={className} onClick={this.focus}>
          ...
          <div className="post-message-bottom">
              <div className="box-icon"><p>+</p></div>
              <BlockStyleControls
              editorState={editorState}
              onToggle={this.toggleBlockType}
            />
            <div className="submit-message">
              <IoMdSend onClick={this.handleSubmit}/>
            </div>
          </div>
        </div>
      </div>
